...
public class WeightedListEditor : BasePropertyDrawer
{
    ...
    private SerializedWeightedListParent targetWeightedList;
    ...
    internal override void AtStartOfGUI(SerializedProperty property)
    {
        ...
        targetWeightedList = target as SerializedWeightedListParent;
        targetWeightedList.InitializeIfNull();
    ...
    private void DrawElement(Rect rect, int index, bool isActive, bool isFocused)
    {
        ...
        EditorGUI.PropertyField(_ElementRect, _currentSerializedElement, GUIContent.none);
